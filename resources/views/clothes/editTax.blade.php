    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header bg-info">
                <h5 class="modal-title" id="exampleModalLabel">تحديث ضريبة المغسلة</h5>
                <button type="button" class="btn" data-dismiss="modal" aria-label="Close">
                    <i class="fas fa-times"></i>
                </button>
            </div>
            {!! Form::open(['route' => ['tax.clothe.update', $tax->id], 'method' => 'POST', 'enctype' => 'multipart/form-data', 'class' => 'text-right']) !!}
                @csrf
                @method('put')
                <div class="modal-body">
                    <div class="form-group row mx-0">
                        ...
                        <div class="form-group col-md-6">
                            ...
                            {{Form::text('tourism', $tax->stamp, ['class' => 'form-control'])}}
                        </div>
                    </div>
