...
@section('content')
    <div class="container-fluid">
        <h1 class="text-center mb-4">فواتير المطعم الخارجية</h1>
        <div class="col-md-6 mt-3 unprint">
            <form action="{{ route('restaurants.bills1') }}" method="GET" role="search">
                <div class="input-group">
                    ...
                    <a href="{{ route('restaurants.bills1') }}" class="">
                        <span class="input-group-btn">
                                ...
                                @if (count($bills))
                                    @foreach ($bills as $bill)
                                        ...
                                        <tr class="odd">
                                            ...
                                            <td class="unprint">
                                                <a href="/rebill/{{ $bill->id }}" class="btn btn-tool">
