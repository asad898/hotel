<!-- Create Modal -->
<div class="modal fade" id="labillsave{{ $labill->id }}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
    aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form class="text-right" method="POST" action="{{ route('labill.store.save', $labill->id) }}">
                @csrf
                @method('put')
                <div class="row m-0">
